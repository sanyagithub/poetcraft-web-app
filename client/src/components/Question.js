...
function Question({ videoId, question, onSubmit }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/answers/submit`, {
                username,
                videoId,
    ...
    const loadCommunityAnswers = async () => {
        ...
        try {
            const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/answers/${videoId}`);
